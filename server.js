...
slapp.command('/getSnap', (msg, text)=>{
  ...
  .route('getid1', (msg, state) => {
    ...
    if(randSnap !== ''){
      ...
      host = "https://api-cms-fitrock.kinetise.com/api/kinetise/v2/projects/199a5286a75bd6a4bddd37c6c62ee310/tables/5/rows?id="+randTag+"&access_token=NGU1MzYxYTA1NGNlZDk2NjdlYzQ0OGU4N2Y3M2E5NTNhM2I2NTY0OThkODU5YjVmZDZjMjhmZjY1ZDI5OGFjZg"
    }
